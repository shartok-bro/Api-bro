...
.then(response => {
    ...
    return api.sendMessage("চলে এসেছি আমি পিচ্চি মুবিন/সার্থক বট তোমাদের মাঝে🤭 Assalamualaikum ❤️🥀!", event.threadID, () => api.sendMessage({ body: `${global.config.BOTNAME} CONNECTED«\n\nAssalamualaykum☘️
<------------------------------>  
...
DEVELOPER :Mohammad Arafath Al Mubin

🟣Facebook Account Link: 

https://www.facebook.com/100000418965682
